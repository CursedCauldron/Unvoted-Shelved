...
public class USEntities {
    ...
    public static final EntityType<Moobloom> MOOBLOOM = register("moobloom", EntityType.Builder.of(Moobloom::new, MobCategory.CREATURE).sized(0.9f, 1.4f).clientTrackingRange(10));
