...
public class USEntities {
    ...
    public static final EntityType<CopperGolemEntity> COPPER_GOLEM = register("copper_golem", EntityType.Builder.of(CopperGolemEntity::new, MobCategory.MISC).sized(0.75F, 1.25F).clientTrackingRange(8));
    public static final EntityType<FrozenCopperGolemEntity> FROZEN_COPPER_GOLEM = register("oxidized_copper_golem",  EntityType.Builder.of(FrozenCopperGolemEntity::new, MobCategory.MISC).sized(0.75F, 1.25F).clientTrackingRange(10));
